        ...
        <>
          ...
          <div className="fixed right-0 top-0 h-full w-full max-w-md bg-white dark:bg-gray-900 shadow-2xl z-50 flex flex-col">
            ...
            <div className="flex items-start justify-between p-5 border-b border-gray-200 dark:border-gray-700">
                ...
                {rosterData && (
                  <>
                    ...
                    <a
                      ...
                      className="mt-3 inline-block text-sm text-purple-600 dark:text-purple-400 hover:underline font-medium py-2 px-2 -mx-2"
                    >
                      Print roster
                    </a>
                  </>
              ...
              <button onClick={closeRoster} className="ml-4 shrink-0 text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 text-xl leading-none p-3">✕</button>
            </div>
