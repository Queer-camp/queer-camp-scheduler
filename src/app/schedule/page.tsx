...
import type { ActivityWithSpots, TrackWithSpots, StandingEvent, Resource } from "@/types/database";
...
export default async function SchedulePage({
  ...
  const [
    ...
    supabase.from("resources").select("*").eq("camp_id", campId).order("position"),
  ]);
